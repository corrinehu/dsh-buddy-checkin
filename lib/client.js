	...
	factory: (require) => {
		...
		function App() {
			...
			return /* @__PURE__ */ react.createElement(react.Fragment, null, toast && /* @__PURE__ */ react.createElement("div", { style: {
				...
				fontSize: 12,
				margin: "7px 0"
			} }, "本次启动检查：", data.checkedAt ? new Date(data.checkedAt).toLocaleString() : "—", data.balanceCheckedAt && /* @__PURE__ */ react.createElement(react.Fragment, null, " · 余额更新：", new Date(data.balanceCheckedAt).toLocaleTimeString([], {
				hour: "2-digit",
				minute: "2-digit"
